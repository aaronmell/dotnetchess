...
namespace DotNetEngine.Test.MakeMoveTests
{
    public class BishopTests
    {
        ...
        {
            var gameState = GameStateUtility.LoadGameStateFromFen("8/8/8/8/8/8/3B4/8 w - - 0 1");
        ...
        {
            var gameState = GameStateUtility.LoadGameStateFromFen("8/8/8/8/8/4p3/3B4/8 w - - 0 1");
            gameState.FiftyMoveRuleCount = 10;
        ...
        {
            var gameState = GameStateUtility.LoadGameStateFromFen("8/8/8/8/8/8/3b4/8 b - - 0 1");
        ...
        {
            var gameState = GameStateUtility.LoadGameStateFromFen("8/8/8/8/8/4P3/3b4/8 b - - 0 1");
            gameState.FiftyMoveRuleCount = 10;
